...
/** cerca una chiave nella tabella e restituisce il puntatore di quella chiave
	\param t la tabella in cui cercare
	\param key la chiave da cercare
 
	\retval NULL se l'elemento non e' presente
	\retval p puntatore all'elemento
 */

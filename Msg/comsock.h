...
#define BUFSIZE 1024
#define SIGBLOCK -3
#define LENGTHEADER 2
#define MAXLENGTHUSER 256

#define ERRARGC "ERROR ARG\n"
#define ERRAUTFILE "ERROR FILE AUTORIZZATI\n"
#define ERRLOGFILE "ERROR FILE LOG\n"

#define ERRFORM "Errore formato.\n Uso: ... \n"
#define ERRNAME "ERROR PAHT FILE TROPPO LUNGO\n"
#define ERRCONN "ERROR CONNESSIONE NON RIUSCITA\n"
#define NOSERV "SOCKET NON CORRETTAMENTE ATTIVA (TERMINO)\n"
#define ERRO "ERROR (TERMINO)\n"
